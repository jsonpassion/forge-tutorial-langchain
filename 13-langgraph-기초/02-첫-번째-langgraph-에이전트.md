...
이 섹션에서는 [Session 13.1: LangGraph 소개와 핵심 개념](./01-langgraph-소개와-핵심-개념.md)에서 배운 StateGraph, 노드, 엣지의 개념을 실제 코드로 구현합니다. 이론에서 벗어나 직접 손으로 그래프를 만들고, 컴파일하고, 실행하는 전 과정을 경험하게 됩니다.
