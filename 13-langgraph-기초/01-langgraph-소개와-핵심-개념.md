...
![LLM 애플리케이션의 인지 아키텍처 스펙트럼 — Code에서 Agent까지 LLM 관여도가 높아지는 6단계를 보여주며, LangGraph는 State Machine과 Agent 수준에 해당합니다](../images/ch13/Screenshot-2023-11-27-at-8_22_59-PM-1-1c47eaed.webp "LangGraph: Build Resilient Language Agents as Graphs — LangChain Blog")
