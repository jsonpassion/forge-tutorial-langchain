...
![RAG Sequence Diagram — Document Ingestion과 Query/Retrieval/Generation 두 단계로 구성된 전체 RAG 파이프라인 아키텍처](../images/ch06/rag-pipeline-ingest-query-flow-b-002ef890.png "NVIDIA Technical Blog — RAG 101: Demystifying Retrieval-Augmented Generation Pipelines")
...
![MinHash LSH 기반 유사 중복 탐지 파이프라인 — Shingling, One-hot Encoding, MinHash Signatures, Band and Hash, Candidate Pairs 단계를 보여주는 다이어그램](../images/ch06/89413953597fbfdd36c4fa77ca0eeafaf6cf944a-7f38cb0f.png "Pinecone — Locality Sensitive Hashing (LSH): The Illustrated Guide")
...
![LangChain Indexing API cleanup 모드 비교 — None, Incremental, Full 모드별 중복 제거, 병렬 삽입, 삭제 동작 차이를 보여주는 공식 비교표](../images/ch06/Screenshot-2023-09-06-at-8_36_55-AM-f55965b3.png "LangChain Blog — Syncing data sources to vector stores")
