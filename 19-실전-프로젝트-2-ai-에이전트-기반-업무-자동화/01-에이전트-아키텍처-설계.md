...
**선수 지식**: [Ch13: LangGraph 기초](13-langgraph-기초/01-langgraph-소개와-핵심-개념.md)에서 배운 StateGraph, 노드, 엣지 개념과 [Ch15: 멀티 에이전트 시스템](15-멀티-에이전트-시스템/01-멀티-에이전트-아키텍처-패턴.md)에서 다룬 에이전트 간 협업 패턴
**학습 목표**:
