...
**선수 지식**: [검색기 기초](./01-검색기-기초.md)에서 배운 BaseRetriever 인터페이스, VectorStoreRetriever, similarity/MMR 검색 전략
**학습 목표**:
...
앞서 [검색기 기초](./01-검색기-기초.md)에서 벡터 유사도 기반 검색을 배웠는데요. 이 방식은 "의미적으로 비슷한" 문서를 잘 찾아주지만, 의외로 **정확한 키워드가 포함된 문서를 놓치는 경우**가 꽤 있습니다.
...
- [search_type](./01-검색기-기초.md) (prerequisite)
