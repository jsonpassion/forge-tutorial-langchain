...
![LangChain 컨텍스트 압축 검색기 — 기본 검색기 위에 압축기를 얹어 관련 정보만 추출하는 구조](../images/ch18/screenshot-2023-04-20-at-4_52_12-pm-e98caa9b.png "LangChain Blog — Improving Document Retrieval with Contextual Compression")
...
![RAG 파이프라인 전체 구조 — 문서 수집(임베딩+벡터DB 저장)과 질의 처리(검색+LLM 생성) 두 단계로 구성된 아키텍처](../images/ch18/rag-pipeline-ingest-query-flow-b-002ef890.png "NVIDIA Developer Blog — RAG 101: Demystifying Retrieval-Augmented Generation Pipelines")
...
![Azure AI Search의 하이브리드 검색 파이프라인 — BM25 텍스트 검색과 벡터 검색이 RRF로 병합된 후 시맨틱 리랭킹까지 이어지는 다단계 스코어링 구조](../images/ch18/scoring-over-ranked-results-4d8b8052.png "Microsoft Learn — Relevance in Azure AI Search")
