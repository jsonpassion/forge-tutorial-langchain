...
![LangChain 벤치마크: 도메인 수 증가에 따른 단일 에이전트·스웜·감독자 정확도 비교 — 도메인이 많아질수록 멀티 에이전트의 이점이 커짐](../images/ch15/newplot--1--ab4f94ad.png "Benchmarking Multi-Agent Architectures — LangChain Blog")

![LangChain 벤치마크: 감독자 vs 스웜 토큰 사용량 비교 — 스웜이 약 40% 적은 토큰 소비](../images/ch15/newplot--2--f144d583.png "Benchmarking Multi-Agent Architectures — LangChain Blog")
