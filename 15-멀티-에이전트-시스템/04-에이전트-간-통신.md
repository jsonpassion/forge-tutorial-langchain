...
![LangGraph Supervisor 패턴 — 감독자가 워커 에이전트를 조율하는 아키텍처](../images/ch15/supervisor-diagram-f67b60f3.png "LangChain Blog — LangGraph Multi-Agent Workflows")
...
![Blackboard Architecture — Knowledge Sources가 공유 칠판을 통해 협력하는 구조](../images/ch15/Blackboard-Architecture---1-185399b4.png "GeeksforGeeks — Blackboard Architecture")
