...
**선수 지식**: [1.1 LLM 애플리케이션의 진화와 LangChain](./01-llm-애플리케이션의-진화와-langchain.md)에서 배운 LCEL 파이프 연산자(`|`)와 Runnable 개념, [1.3 개발 환경 설정](./03-개발-환경-설정.md)에서 구축한 가상환경과 API 키 설정
...
ChatOpenAI는 `langchain-openai` 패키지에서 제공하는 OpenAI 채팅 모델 래퍼입니다. [1.1 LLM 애플리케이션의 진화와 LangChain](./01-llm-애플리케이션의-진화와-langchain.md)에서 배운 Runnable 인터페이스를 구현하고 있어서, `invoke`, `stream`, `batch` 등 통합된 메서드를 사용할 수 있습니다.
...
[1.1 LLM 애플리케이션의 진화와 LangChain](./01-llm-애플리케이션의-진화와-langchain.md)에서 파이프 연산자(`|`)를 잠깐 살펴봤는데, 이제 실제로 동작하는 완전한 체인을 만들어 보겠습니다.
...
- [python-dotenv](./03-개발-환경-설정.md) (prerequisite)
- [load_dotenv](./03-개발-환경-설정.md) (prerequisite)
- [venv](./03-개발-환경-설정.md) (prerequisite)
